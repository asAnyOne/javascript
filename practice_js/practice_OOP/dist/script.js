...
/* harmony import */ var _modules_showInfo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/showInfo */ "./src/js/modules/showInfo.js");
/* harmony import */ var _modules_sliders_slider_main__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/sliders/slider-main */ "./src/js/modules/sliders/slider-main.js");
/* harmony import */ var _modules_sliders_slider_mini__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/sliders/slider-mini */ "./src/js/modules/sliders/slider-mini.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  new _modules_sliders_slider_main__WEBPACK_IMPORTED_MODULE_5__["default"]({
    container: ".page",
    nextBtns: ".next"
  }).render();
  new _modules_sliders_slider_main__WEBPACK_IMPORTED_MODULE_5__["default"]({
  ...
  new _modules_sliders_slider_mini__WEBPACK_IMPORTED_MODULE_6__["default"]({
  ...
  new _modules_difference__WEBPACK_IMPORTED_MODULE_0__["default"](".officerold").init();
  new _modules_difference__WEBPACK_IMPORTED_MODULE_0__["default"](".officernew").init();
  new _modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"]("form").init();
  new _modules_showInfo__WEBPACK_IMPORTED_MODULE_4__["default"](".module__info-show").init();
...
function () {
  ...
  _createClass(Differnce, [{
    key: "addClass",
    value: function addClass(elem) {
      var _elem$classList;

      for (var _len = arguments.length, clas = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
        clas[_key - 1] = arguments[_key];
      }

      (_elem$classList = elem.classList).add.apply(_elem$classList, clas);
    }
  }, {
    key: "displayElem",
    value: function displayElem(elem, displayState) {
      elem.style.display = displayState;
    }
  }, {
    key: "hideOfficer",
    value: function hideOfficer() {
      var _this = this;

      this.officerItems.forEach(function (item, i) {
        _this.addClass(item, "animated", "fadeIn");

        if (i !== 0 && i !== _this.officerItems.length - 1) {
          _this.displayElem(item, "none");
        }
      });
    }
  }, {
    key: "bindTrigger",
    value: function bindTrigger(items, index, btn) {
      var _this2 = this;

      this.addBtn.addEventListener("click", function () {
        _this2.displayElem(btn, "none");

        _this2.displayElem(items[index], "flex");

        if (index !== items.length - 2) {
          setTimeout(function () {
            return _this2.displayElem(btn, "flex");
          }, 300);
        }
    ...
    value: function init() {
      ...
      this.btns.forEach(function (btn) {
        ...
        btn.addEventListener("click", function () {
          return _this.download(_this.path);
        });
      });
    }
  }]);
...
function () {
  ...
  _createClass(Forms, [{
    key: "initMask",
    value: function initMask(selector) {
      ...
      function createMask(event) {
        ...
        this.value = matrix.replace(/./g, function (arg) {
          return /[_\d]/.test(arg) && i < val.length ? val.charAt(i++) : i >= val.length ? "" : arg;
        });
    ...
    key: "chekEmailInputs",
    value: function chekEmailInputs() {
    ...
    value: function addEventForms() {
      ...
      this.forms.forEach(function (form) {
        return form.addEventListener("submit", function (e) {
          ...
          _this.postData(_this.path, formData).then(function (data) {
            console.log(data);
      ...
      this.btns.forEach(function (btn, i) {
        ...
        btn.addEventListener("click", function () {
          if (!btn.getAttribute("data-blocked")) {
            try {
              _this.activeBtn = btn;
              _this.nextBtn = btn.parentNode.nextElementSibling.lastElementChild;
              _this.nextBtnParent = btn.parentNode.nextElementSibling;
            } catch (error) {}
...
function () {
  ...
  _createClass(ShowInfo, [{
    key: "init",
    value: function init() {
      this.infoBtns.forEach(function (btn) {
        var infoText = btn.nextElementSibling;
        infoText.classList.add("animated", "fadeIn");
        var active = false;
        btn.addEventListener("click", function () {
          active = !active;
          infoText.style.display = active ? "block" : "none";
          btn.lastElementChild.firstElementChild.firstElementChild.firstElementChild.style.display = active ? "none" : "block";
        });
      });
    }
  }]);
...
function (_Slider) {
  ...
  function SliderMain(nextBtns, prevBtns) {
    _classCallCheck(this, SliderMain);

    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMain).call(this, nextBtns, prevBtns));
  }
...
function (_Slider) {
  ...
  function SliderMini(container, next, prev, activeClass, animate, autoplay) {
    _classCallCheck(this, SliderMini);

    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMini).call(this, container, next, prev, activeClass, animate, autoplay));
  }
  ...
  _createClass(SliderMini, [{
    ...
    value: function bindTrigger() {
      ...
      this.prev.addEventListener("click", function () {
        ...
        var lastElem = _this3.slides[_this3.slides.length - 3];

        _this3.container.insertBefore(lastElem, _this3.slides[0]);
