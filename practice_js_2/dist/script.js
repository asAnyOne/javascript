...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_6__["default"])(".feedback-slider-item", ".main-prev-btn", ".main-next-btn");
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_6__["default"])(".main-slider-item", "", "", "vertical");
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_3__["default"])("[name=phone]");
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_1__["default"])("[name=text]");
  ...
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_0__["default"])("#size", "#material", "#options", "input.promocode", ".calc-price");
});
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunction = function calcFunction() {
    ...
    if (sizeBlock.value === "") {
      ...
      resultBlock.textContent = "Для расчета нужно выбрать , и материал картины";
...
var forms = function forms() {
  ...
  var inputsPhone = document.querySelectorAll("input[name=user_phone]");
  ...
  upload.forEach(function (item) {
    return item.addEventListener("input", function () {
      ...
      item.previousElementSibling.textContent = arr[0].slice(0, 10) + dots + arr[arr.length - 1];
    });
  });
  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      var api;
      (item.closest(".popup-design") || item.closest(".calc")) && (api = path.designer);
      (item.closest(".popup-consultation") || item.closest(".consultation")) && (api = path.question);
...
var modals = function modals() {
  ...
  var handleTimeout = setTimeout(function () {
    return showModalByTime(".popup-consultation", 4);
  }, 5000000);
  ...
  function closeModal(windows) {
    ...
    document.querySelector(".fixed-gift") && (document.querySelector(".fixed-gift").style.marginRight = "0px");
  }

  function showModal(e, windows, modal) {
    e.preventDefault();
    windows.forEach(function (item) {
      return (item.style.display = "none") && item.classList.add("animated", "fadein");
    });
    modal.style.display = "block";
    document.body.style.overflow = "hidden";
    document.body.style.marginRight = "".concat(scroll, "px");
    document.querySelector(".fixed-gift") && (document.querySelector(".fixed-gift").style.marginRight = "".concat(scroll, "px"));
    e.target.classList.contains("fixed-gift") && window.removeEventListener("scroll", showModalByScroll);
  }
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      return item.addEventListener("click", function (e) {
        return e.target && showModal(e, windows, modal) || clearInterval(handleTimeout) || destroyTrigger && e.target.remove();
      });
    });
    closeBtn.addEventListener("click", function () {
      return closeModal(windows);
    });
    modal.addEventListener("click", function (e) {
      return e.target === modal && closeModal(windows);
    });
  }
...
var showMoreStyles = function showMoreStyles(selector) {
  var styles = document.querySelector("#styles>div>div"),
      newStyles = styles.querySelectorAll(".hidden-lg.hidden-md.hidden-sm.hidden-xs.styles-2"),
  ...
  addBtn.addEventListener("click", function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getData"])("assets/db.json").then(function (res) {
      return createNewStyles(res.styles);
...
var sliders = function sliders(slideSelector, prev, next, dir) {
